...
Since 2020, food manufacturers can also contribute by sharing data on their products manually through a Pro interface or [automatically via the platoform of the company Equadis](https://fr.blog.openfoodfacts.org/news/des-donnees-produits-sur-open-food-facts-en-direct-des-fabricants-et-en-temps-reel-avec-equadis).
...
And, as in all MediaWiki plateform, OFF's logs are entirely public : you can access them by clicking **Edit** on a product's page and scroll down.
...
.pull-left-wide[
OFF community also uses the MediaWiki features to organise human scrutiny.
