...
## What tool do you use, as a consumer, to assess nutritious facts ?


---

### The Nutri-Score's brit uncle : the NP

.pull-left[
.center[
![](./img/ofcom_obesity.png)
]
]

.pull-right[
[The NP (for nutrient profiling) model](https://www.gov.uk/government/publications/the-nutrient-profiling-model) was developped by the UK Food Standard Administration in 2004-2005 to help the Office for Communication improve balance of television advertising for kids
...
The NP grading system is based on proportion of macro nutritent for 100 grams of weight.

It grants *"A points"* for good nutrients and *"C points"* for bad ones.

.pull-left[
.center[
![](./img/np_apoint_table.png)
]
]
...
.pull-right[
With a delighfully specific policy for coconut and its byproducts.
...
background-image: url("https://media.giphy.com/media/QutMixj7ca3deO7B0h/giphy.gif")
class: center, top, inverse

### But why for 100 grams ?
...
.pull-right[![](./img/food_label_eu_standard.jpg)

The information is required to be expressed .red[**per 100 grams or per 100 ml**] (per portion is optional).
...
background-image: url(https://media.giphy.com/media/l4RKhOL0xiBdbgglFi/giphy.gif)

class: inverse, center, top

### Nutrition grading = effect of data availability
...
background-image: url(https://media.giphy.com/media/13rnKUt0bn5LVe/giphy.gif)
...
### The Nutri-Score : a "score" for health nutrition national plan


In 2014, Santé Publique France's Pr. Serge Hercberg and his team designed a indicator of the nutritional quality based on a letter graduation (from A to E) ranging the food products from the most to the least healthy : the [Nutri-Score](https://www.vie-publique.fr/rapport/33810-propositions-pour-un-nouvel-elan-de-la-politique-nutritionnelle). It sets two goals to the this "score" :

.pull-left[
*a) permettre aux consommateurs d’appréhender en un coup d’œil et de façon
compréhensible la qualité nutritionnelle globale des aliments au moment de leur
acte d’achat. Le consommateur pourra ainsi intégrer la dimension nutritionnelle
dans les arbitrages orientant ses choix par une comparaison simple entre aliments
de familles différentes et, dans la même famille, entre différentes marques ou
entre formulations d’une même marque ;*
]

.pull-right[
*b) inciter les producteurs et distributeurs d’aliments à améliorer la qualité
nutritionnelle des aliments qu’ils produisent ou distribuent afin de « bénéficier »
d’un positionnement le plus favorable possible sur le système d’information
nutritionnel (sur l’échelle de qualité nutritionnelle visible par les consommateurs)
