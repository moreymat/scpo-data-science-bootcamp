...
He is a researcher in computer science, specialized in data science and machine learning. He is consultant at .red[Datactivist]. | Datajournalist and consultant at .red[Datactivist], he works with civil society and public actors on data literacy, data analysis & open data. | Graduated from the Urban School of SciencesPo, he is consultant at .red[Datactivist] and works with local and national governments.
...
- Datactivist is a French cooperative company specialized in open data created in 2016 with a mission to .red[**open data and make them useful**].

- On all stages of the work of opening data, Datactivist works with .red[**both data producers and reusers**] and participates in the appropriation of data by everyone.
...
### One (very) quick example of what .red[Datactivist] can do
...
- after lunch breah - 20 minutes presentation by Syvlain
